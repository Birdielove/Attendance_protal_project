...
public class acc extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "admin", "teacher", "student" }));
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "admin", "teacher", "student" }));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try
        {
            ...
            con= (com.mysql.jdbc.Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/project","root","admin");
            stmt=(com.mysql.jdbc.Statement) con.createStatement();
            stmt1=(com.mysql.jdbc.Statement) con.createStatement();
            String Query="insert into login(name,password,user) values('"+jTextField3.getText()+"','"+jTextField4.getText()+"','"+jComboBox2.getSelectedItem()+"')";
